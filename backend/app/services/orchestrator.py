...
class TravelOrchestratorService:
    ...
    async def generate_travel_recommendations(
        ...
        try:
            ...
            cultural_data, weather_data, style_data, currency_data = await asyncio.gather(*api_tasks)
            ...
            return ChatResponse(
                message="I apologize, but I'm having trouble processing your request. Please try again or be more specific about your travel plans.",
    ...
    async def _safe_api_call(self, api_func, *args, **kwargs):
        ...
        try:
            ...
            logger.error(f"API call failed: {api_func.__name__} - {str(e)}")
            return None
    ...
    def _parse_trip_context(self, user_message: str, context: ConversationContext) -> Dict[str, Any]:
